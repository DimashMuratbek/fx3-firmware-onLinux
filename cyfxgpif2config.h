/*
 * Project Name: Update_Continuous_read.cyfx
 * Time : 02/20/2025 13:32:49
 * Device Type: FX3
 * Project Type: GPIF2
 *
 *
...
#ifndef _INCLUDED_UPDATE_CONTINUOUS_READ_CYDSN_
#define _INCLUDED_UPDATE_CONTINUOUS_READ_CYDSN_
#include "cyu3types.h"
#include "cyu3gpif.h"
...
CyU3PGpifWaveData CyFxGpifWavedata[]  = {
    {{0x1E739A01,0x00000100,0x80000000},{0x00000000,0x00000000,0x00000000}},  /* Optimized for 32-bit data */
    {{0x2E739A02,0x20000000,0x80000000},{0x00000000,0x00000000,0x00000000}}   /* Optimized for 32-bit data */
};
...
uint32_t CyFxGpifRegValue[]  = {
    ...
    0x0000006C,  /*  CY_U3P_PIB_GPIF_BUS_CONFIG - 32-bit mode */
    ...
    0x00000000,  /*  CY_U3P_PIB_GPIF_EGRESS_ADDRESS */
    0x00000000,  /*  CY_U3P_PIB_GPIF_EGRESS_ADDRESS */
    0x80010400,  /*  CY_U3P_PIB_GPIF_THREAD_CONFIG - Thread 0 */
    0x80010401,  /*  CY_U3P_PIB_GPIF_THREAD_CONFIG - Thread 1 */
    0x80010402,  /*  CY_U3P_PIB_GPIF_THREAD_CONFIG - Thread 2 */
    0x80010403,  /*  CY_U3P_PIB_GPIF_THREAD_CONFIG - Thread 3 */
